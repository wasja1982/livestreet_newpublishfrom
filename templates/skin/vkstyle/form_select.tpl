<div class="row">
	<div class="width-12">
		...
		<span class="help-block bg-success">{if $bTopic}{$aLang.plugin.newpublishfrom.publishfrom_note_topic}{else}{$aLang.plugin.newpublishfrom.publishfrom_note_comment}{/if}</span>
	</div>
</div>